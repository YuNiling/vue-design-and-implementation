// ** 预字符串化
// 1. “预字符串化”：基于静态提升的一种优化策略。
// 2. 其优势如下：
// 2.1 大块的静态内容可以通过 innerHTML 进行设置，在性能上具有一定优势。
// 2.2 减少创建虚拟节点产生的性能开销。
// 2.3 减少内存占用。
...
// **测试： 
// 方案一：静态提升
// const hoist1 = createVNode('p', null, '1');
// const hoist2 = createVNode('p', null, '2');
// const hoist3 = createVNode('p', null, '3');
// const hoist4 = createVNode('p', null, '4');
// const hoist5 = createVNode('p', null, '5');
// function render1(ctx) {
//   return (openBlock(), createBlock('div', null, [
//     hoist1, hoist2, hoist3, hoist4, hoist5,
//     createVNode('p', null, ctx.title, PatchFlags.TEXT)
//   ]));
// }
// const vnode1 = render1({ title: '测试标题1' });
// console.log('vnode1', vnode1);
// renderer.render(vnode1, document.querySelector('#app'));

// 方案二：预字符串化
const hoistStatic = createStaticVNode(`<p>1</p><p>2</p><p>3</p><p>4</p><p>5</p>`);
...
const vnode2 = render2({ title: '测试标题2' });
