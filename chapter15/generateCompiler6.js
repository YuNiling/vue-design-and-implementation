 ...
 * @param {Number} indent 缩进的级别（节点层级 * 2）
 */
...
/**
 * 为 FunctionDecl 类型节点生成对应的 Javascript 代码
...
function genFunctionDecl(node, context) {
  ...
  // node.id 是一个标志符，用来描述函数的名称，即 node.id.name
...
/**
 * 为 ReturnStatement 类型节点生成对应的 Javascript 代码
 * @param {Object} node 节点
 * @param {Object} context 上下文对象
 */
...
/**
 * 为 CallExpression 类型节点生成对应的 Javascript 代码
 * @param {Object} node 节点
 * @param {Object} context 上下文对象
 */
...
/**
 * 为 StringLiteral 类型节点生成对应的 Javascript 代码
 * @param {Object} node 节点
 * @param {Object} context 上下文对象
 */
function genStringLiteral(node, context) {
  const { push } = context;
  // 对于字符串字面量，只需要追加与 node.value 对于的字符串即可
  push(`'${node.value}'`);
}

/**
 * 为 ArrayExpression 类型节点生成对应的 Javascript 代码
 * @param {Object} node 节点
 * @param {Object} context 上下文对象
 */
...
/**
 * 生成代码
 * @param {Object} node Javascript AST
 * @param {Object} context 上下文对象
 */
