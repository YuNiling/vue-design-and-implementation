...
// ** 测试
// const template = `<div>Text&lt;测试</div>`;
// const ast = parse(template);
// console.log(ast);

// console.log('&%e', decodeHtml('&%e'));
// console.log('a&lt;b', decodeHtml('a&lt;b'));
// console.log('a&ltccbbb', decodeHtml('a&ltccbbb'));
// console.log('a=1&lt=2', decodeHtml('a=1&lt=2', true));
