// * 注册生命周期
// * 1.在 setup 函数中调用 onMounted 函数即可注册 mounted 生命周期钩子函数，并且通过多次调用 onMounted 函数注册多个钩子函数，这些函数会在组件被挂载之后再执行。
// * 2.钩子函数如何与组件实例进行关联。
...
//   },
//   render() {
//     return { type: 'div', children: 'mounted test' }
//   }
// };
// const vnode = {
//   type: MyComponent
