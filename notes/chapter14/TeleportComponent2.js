...
import { Text, Comment, Fragment, KeepAlive, Teleport } from '../NODE_TYPE.js';
import { setCurrentInstance, onActivated, onDeactivated } from '../lifeCycle.js';
      ...
      return {
        ...
        children: [
          { 
            type: 'div',
            props: {
              class: 'modal-teleport-div'
            },
            children: [
              {
                type: 'p', 
                children: 'Hello from the modal!' 
              },
              {
                type: 'button',
                props: {
...
renderer.render(vnode, document.querySelector('#modalApp'));